...
test_that("as.list.Gabel", {
  ...
  expect_equal(lst[[1]]$label, 1L)
  expect_equal(lst[[1]]$s, G1$s)
  expect_equal(lst[[1]]$j, G1$j)
  expect_equal(lst[[1]][[1]]$label, 2L)
  expect_equal(lst[[1]][[1]]$s, G2$s)
  expect_equal(lst[[1]][[1]]$j, G2$j)
  expect_equal(lst[[1]][[2]]$label, 3L)
  expect_equal(lst[[1]][[2]]$y, G3$y)
  expect_equal(lst[[1]][[1]][[1]]$label, 4L)
  expect_equal(lst[[1]][[1]][[2]]$label, 5L)
  expect_equal(lst[[1]][[1]][[1]]$y, G4$y)
  expect_equal(lst[[1]][[1]][[2]]$y, G5$y)
})
