...
**Idea for quantiles:** ab einer gewissen Anzahl an Datenpunkte werden Quantile (`quantile()`) mit einer %-Anzahl an Wahrscheinlichkeiten verwendet für das Minimierungsproblem, anstatt die Datenpunkte selbst.
